...
- **A genuinely new entity** (products, bookings, anything that isn't
  ...
  `Bundle/Modules/Accounts/Auth/Controllers/FwAccountsController.php` vs. a
...
[`Bundle/Modules/Accounts/Balance/Tables/FwBalanceLedger.php`](../../Bundle/Modules/Accounts/Balance/Tables/FwBalanceLedger.php)
for the same pattern with an `ENUM` column and a static helper method.
Register the table's migration the usual way — see
[`../database.md`](../../reference/layers/database.md).
...
`FwAccountsController` (`Bundle/Modules/Accounts/Auth/Controllers/FwAccountsController.php`)
...
use PHPCraftdream\Garnet\Bundle\Modules\Accounts\Auth\Controllers\FwAccountsController;
...
in [`../cli.md`](../../reference/cli.md) is unrelated (`php garnet admin` mints a
...
[`../bundle.md`](../../reference/layers/bundle.md) for the full middleware picture and the
...
- [`../bundle.md`](../../reference/layers/bundle.md) — `IEntityConfig` in one paragraph,
  reusable controllers table, admin/public controller separation.
- [`../database.md`](../../reference/layers/database.md) — `DbTable` reference.
- The testing guide — Playwright coverage for an admin CRUD page (auth,
  ...
  [`e2e-testing.md`](../../guides/e2e-testing.md).
