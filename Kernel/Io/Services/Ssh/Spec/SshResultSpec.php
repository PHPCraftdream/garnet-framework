...
namespace PHPCraftdream\Garnet\Kernel\Io\Services\Ssh\Spec {
    use Error;
    use PHPCraftdream\Garnet\Kernel\Io\Services\Ssh\SshResult;
    use PHPCraftdream\Garnet\Kernel\Io\Services\Ssh\SshTestResult;
