...
namespace PHPCraftdream\Garnet\Bundle\Modules\Ops\Logging\Spec\LogsController {
    use Closure;
    use LogicException;
    use PHPCraftdream\Garnet\Bundle\Modules\Ops\Logging\Admin\Controllers\FwDashboardLogsController;
