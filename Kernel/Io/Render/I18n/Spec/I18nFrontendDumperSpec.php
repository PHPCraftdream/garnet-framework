...
namespace PHPCraftdream\Garnet\Kernel\Io\Render\I18n\Spec {
    ...
    describe('I18nFrontendDumper', function (): void {
        ...
        describe('dump()', function (): void {
            ...
            it('throws exception when template file cannot be read', function (): void {
                $backupDir = dirname(__DIR__, 5) . DIRECTORY_SEPARATOR . 'Templates' . DIRECTORY_SEPARATOR . 'CodeFiles' . DIRECTORY_SEPARATOR;
