...
Bundle/Support/I18n/...PHP ─►  Codegen `*I18nGen.ts`           hashed *.gen.js
...
Recipe for a fresh island: [`cookbook/add-an-island.md`](../../cookbook/add/add-an-island.md).
...
- [`bundle.md`](bundle.md) — what a bundle ships (PHP + Twig + TSX +
  Front-end).
- [`cookbook/add-an-island.md`](../../cookbook/add/add-an-island.md) — recipe.
