...
namespace PHPCraftdream\Garnet\Bundle\Modules\Content\News\Tables {
    use PHPCraftdream\Garnet\Kernel\Db\Tables\DbTable;
    use PHPCraftdream\Garnet\Kernel\Db\Tables\DbTableBuilderFactory;
    use PHPCraftdream\Garnet\Kernel\Interfaces\Db\ITableBuilderDriver;

    abstract class FwNewsReads extends DbTable {
        ...
        public static function init(): ITableBuilderDriver {
            return DbTableBuilderFactory::newCreateTable(table: static::get())
                ...
                ->addColumn(column: 'read_at', type: 'INT', length: '11', null: false, default: '0')
