...
Recipe: [`cookbook/add-a-route.md`](../../cookbook/add/add-a-route.md).
...
The [`Logging`](../../../Bundle/Modules/Ops/Logging/README.md) bundle layers an
...
The [Email queue's flush state](../../../Bundle/Modules/Comms/Email/README.md) and
...
[Email bundle](../../../Bundle/Modules/Comms/Email/README.md); the kernel piece is
...
The Cron *bundle* (`Bundle/Modules/Ops/Cron/`) adds the `cron_log` table
and admin viewer. Recipe:
[`cookbook/add-a-cli-command.md`](../../cookbook/add/add-a-cli-command.md).
...
- [`deploy.md`](../../guides/deploy.md) — `bundle` and `deploy:diff`.
