...
namespace PHPCraftdream\Garnet\Kernel\Io\Http\Forms\Spec;

use PHPCraftdream\Garnet\Kernel\Io\Http\Forms\ImageUploadParams;
...
describe('ImageUploadParams', function (): void {
    describe('constructor', function (): void {
        ...
        it('creates params with all fields', function (): void {
            $cropParams = new \PHPCraftdream\Garnet\Kernel\Io\Http\Forms\ImageCropParams(
