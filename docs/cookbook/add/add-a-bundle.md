...
itself is built out of bundles (`Bundle/Modules/Accounts/Auth`,
`Bundle/Modules/Comms/Comments`, …); you add your own the same way.
...
- [`../bundle.md`](../../reference/layers/bundle.md) — full bundle reference.
