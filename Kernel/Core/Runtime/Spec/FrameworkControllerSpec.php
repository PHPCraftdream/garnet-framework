...
namespace PHPCraftdream\Garnet\Kernel\Core\Runtime\Spec;
...
describe('FrameworkController', function (): void {
    ...
    beforeAll(function () use (
        ...
        $reflection = new ReflectionClass(\PHPCraftdream\Garnet\Kernel\Core\Support\Tools\RuntimeParams::class);
