...
[`deploy.md`](../../guides/deploy.md) — same word, different thing.
...
| `FwCmsController` | CMS-style content listing on top of [StaticPages](../../../Bundle/Modules/Content/StaticPages/README.md). |
...
- Validation rules for each field (same `fieldsInfo` shape that
  ...
  [`cookbook/add-validation-rules.md`](../../cookbook/add/add-validation-rules.md)).
...
| Module | Capsule |
|---|---|
| [Auth](../../../Bundle/Modules/Accounts/Auth/README.md) | Passwordless email magic-link auth. CSRF + brute-force mitigations. |
| [Balance](../../../Bundle/Modules/Accounts/Balance/README.md) | Immutable transaction ledger + cached account balance. |
| [Comments](../../../Bundle/Modules/Comms/Comments/README.md) | Generic "comments on anything" store. |
| [Cron](../../../Bundle/Modules/Ops/Cron/README.md) | Scheduled tasks via `php garnet cron`. |
| [Dashboard](../../../Bundle/Modules/Content/Dashboard/README.md) | Admin-panel scaffold with menus + role gate. |
| [Email](../../../Bundle/Modules/Comms/Email/README.md) | `symfony/mailer` + queue table + cron drainer. |
| [EntityHistory](../../../Bundle/Modules/Ops/EntityHistory/README.md) | Per-entity audit log with lazy schema. |
| [Idempotency](../../../Bundle/Modules/Ops/Idempotency/README.md) | Server-side idempotency keys for client retries. |
| [Invite](../../../Bundle/Modules/Accounts/Invite/README.md) | Invite-token registration with CAS consume. |
| [JsErrors](../../../Bundle/Modules/Ops/JsErrors/README.md) | Browser `window.onerror` collector with dedupe. |
| [Logging](../../../Bundle/Modules/Ops/Logging/README.md) | App-event log + admin viewer + mail/request sub-loggers. |
| [Messaging](../../../Bundle/Modules/Comms/Messaging/README.md) | User-to-user direct messages. |
| [News](../../../Bundle/Modules/Content/News/README.md) | News / announcement feed. |
| [StaticPages](../../../Bundle/Modules/Content/StaticPages/README.md) | Block-based static page editor. |
| [Support](../../../Bundle/Modules/Comms/Support/README.md) | Support tickets with attachments + internal notes. |
| [SystemSettings](../../../Bundle/Modules/Ops/SystemSettings/README.md) | Owner-only runtime settings (brand, SMTP, contacts, SEO). |

## Writing your own bundle

Walk-through in [`cookbook/add-a-bundle.md`](../../cookbook/add/add-a-bundle.md).
The short version:
...
- [`cookbook/add-a-bundle.md`](../../cookbook/add/add-a-bundle.md) — start-to-finish recipe.
- [`cookbook/add-a-route.md`](../../cookbook/add/add-a-route.md) — routing.
