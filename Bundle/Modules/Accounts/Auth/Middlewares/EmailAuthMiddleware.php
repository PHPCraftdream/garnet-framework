...
namespace PHPCraftdream\Garnet\Bundle\Modules\Accounts\Auth\Middlewares {
    ...
    use PHPCraftdream\Garnet\Bundle\Modules\Accounts\Auth\AuthStrategy\AuthStrategyInterface;
    ...
    use PHPCraftdream\Garnet\Kernel\Core\Support\Tools\DateTools;
    ...
    class EmailAuthMiddleware implements AuthStrategyInterface {
        ...
        protected static function sendCode(IGlobalReqParams $globals, string $authEmail): void {
            ...
            $render = $twig->render('Email/layout/Email.twig', static::authEmailParams($globals, $authCode, $magicToken));
            $render = HtmlMinify::get()->minify($render);
