...
- [`../docs/reference/layers/database.md`](../docs/reference/layers/database.md) — the data layer in depth.
- [`../docs/reference/layers/io.md`](../docs/reference/layers/io.md) — the IO subsystem in depth.
