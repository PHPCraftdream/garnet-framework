...
namespace PHPCraftdream\Garnet\Bundle\Modules\Accounts\Auth\Middlewares\Spec {
    use DateTimeInterface;
    use PHPCraftdream\Garnet\Bundle\Modules\Accounts\Auth\AuthStrategy\AuthConfig;
    ...
    describe('AuthMiddleware', function (): void {
        ...
        describe('processOrigin()', function (): void {
            ...
            it('returns null when HTTP_ORIGIN is set to an allowed origin', function (): void {
                \PHPCraftdream\Garnet\Bundle\Modules\Accounts\Auth\AuthStrategy\Spec\makeAuthConfig(['allowed_origins' => ['http://example.com', 'https://app.example.com']]);
            ...
            it('returns a 400 response with "Bad origin" when HTTP_ORIGIN is disallowed', function (): void {
                \PHPCraftdream\Garnet\Bundle\Modules\Accounts\Auth\AuthStrategy\Spec\makeAuthConfig(['allowed_origins' => ['http://example.com']]);
            ...
            it('returns null when HTTP_ORIGIN is absent and HTTP_REFERER is an allowed origin (with port)', function (): void {
                \PHPCraftdream\Garnet\Bundle\Modules\Accounts\Auth\AuthStrategy\Spec\makeAuthConfig(['allowed_origins' => ['http://example.com:8080']]);
