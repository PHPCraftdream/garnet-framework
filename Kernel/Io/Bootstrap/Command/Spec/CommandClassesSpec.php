    ...
    describe('CommandClasses', function (): void {
        ...
        describe('::set() and ::get()', function (): void {
            ...
            it('throws exception for non-existent class', function (): void {
                ...
                $expect->toThrow(new \PHPCraftdream\Garnet\Kernel\Exceptions\Io\CommandException('Unknown class (#1): NonExistentClass'));
            });
            ...
            it('throws exception for class not implementing ICommand', function (): void {
                ...
                $expect->toThrow(new \PHPCraftdream\Garnet\Kernel\Exceptions\Io\CommandException());
            });
            ...
            it('throws exception when getting non-existent command', function (): void {
                ...
                $expect->toThrow(new \PHPCraftdream\Garnet\Kernel\Exceptions\Io\CommandException('Command not found: nonexistent'));
            });
