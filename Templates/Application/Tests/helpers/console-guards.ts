 ...
 *
 * Allowlist: edit ALLOWLIST below to silence known noise for your app.
 * Each entry is a regex tested against the issue's text. Keep this list
 * tight — the whole point is that real warnings fail the build.
 */
...
const ALLOWLIST: RegExp[] = [
    ...
    // console.error. Specs that intentionally exercise error paths
    ...
    // EventSource teardown, not a product fault.
