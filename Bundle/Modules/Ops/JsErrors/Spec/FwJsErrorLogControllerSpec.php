...
namespace PHPCraftdream\Garnet\Bundle\Modules\Ops\JsErrors\Spec {
    use Closure;
    use LogicException;
    use PHPCraftdream\Garnet\Bundle\Modules\Ops\JsErrors\Controllers\FwJsErrorLogController;
