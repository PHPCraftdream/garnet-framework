...
use PHPCraftdream\Garnet\Kernel\Io\GarnetCli\Commands\Deploy\DeployDiff\DeployDiffPathsTrait;
use PHPCraftdream\Garnet\Kernel\Io\GarnetCli\Commands\Deploy\DeployDiff\DeployDiffPlannerTrait;
use PHPCraftdream\Garnet\Kernel\Io\GarnetCli\Commands\Deploy\DeployDiff\DeployDiffRemoteTrait;
use PHPCraftdream\Garnet\Kernel\Io\GarnetCli\Commands\Deploy\DeployDiff\DeployDiffReportTrait;
...
final class GarnetDeployDiffCommand {
    ...
    private static function doRun(array $opts): void {
        ...
        if ($rebrandNeeded) {
            ...
            // b) Inject the five *Gen.php files. They are regenerated by
