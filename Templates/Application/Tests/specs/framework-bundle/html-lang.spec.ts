 ...
 *
 * The framework's twig layouts always resolve `lang|default('en')` — this
 * spec exists so it doesn't regress: if someone ever swaps the lang back
 * to "auto" or removes the attribute, this test fails loudly.
 *
 * The scaffolded template only ships a single public route (`/`) — grow
 * the URLS list as the app gains more public pages.
 */
